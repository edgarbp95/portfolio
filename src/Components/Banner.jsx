...
const Banner = () => {
  return (
    <div className='w-3/4 mx-auto text-center z-10 px-52 flex flex-col gap-6 pb-10 sm:px-0'>
      ...
      <p className='text-white text-justify text-lg mb-6 mx-auto mt-6 tracking-wider leading-7 sm:text-base sm:hidden '>Hola! Mi nombre es Edgar Buenaño y te doy la bienvenida a mi portfolio, dónde encontrarás todos mis proyectos. Si tienes una empresa y quieres ganar presencia en la web, o bien, si eres empleador y estás buscando contratar, no dudes en ponerte en contacto.
      </p>
