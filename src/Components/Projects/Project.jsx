  ...
  return (
      <div ref={refe} className="bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700  relative  mb-4 sm:w-96">
        ...
        <div className="px-4 py-3 flex flex-col gap-2 items-center sm:h-32 sm:justify-between">
            <a href={web}>
            <h5 className="mb-2 text-lg font-medium tracking-tight text-gray-900 dark:text-white sm:text-sm">
                {tittle}
            </h5>
            </a>
            <div className='flex gap-2 '>
                ...
                >
                <p className='sm:hidden'>Visitar sitio</p>
                <p className='hidden sm:flex sm:mx-auto'>Ver</p>
                </a>
                <a
                href={github}
                target="_blank"
                >
                <ButtonCard clase="sm:w-16" textButton="Github"/>
                </a>
            </div>
